...
public class DefaultStreamLoader implements StreamLoader {
    ...
    public StreamLoadResponse send(List<AirbyteRecordMessage> records) throws Exception {
        ...
        LOG.info("Akashx httpPut {} {} {} {} {}", httpPut, records, label, database, loadTable);
        ...
        try (CloseableHttpClient client = HttpClients.createDefault();) {
            ...
            StreamLoadResponse.StreamLoadResponseBody streamLoadBody = JSON.parseObject(responseBody,
                    StreamLoadResponse.StreamLoadResponseBody.class);
        ...
        for (;;) {
            ...
            try (CloseableHttpClient client = HttpClients.createDefault()) {
                ...
                try (CloseableHttpResponse response = client.execute(httpGet)) {
                    ...
                    StreamLoadResponse.StreamLoadResponseBody responseBody = JSON.parseObject(entityContent,
                            StreamLoadResponse.StreamLoadResponseBody.class);
